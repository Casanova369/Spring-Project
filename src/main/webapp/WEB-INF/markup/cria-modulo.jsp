...
<main>
    ...
    <form class="grid" action="/plataform/modulo/create" method="post">
        <label for="title"><b>Titulo do Modulo</b></label>
        <input type="text" placeholder="Digite um titulo" id="title" name="title" required>

        <label for="description">Texto do Modulo</label>

        <textarea id="description" name="description" rows="4" cols="50"></textarea>

        <button>Cria modulo</button>
    </form>
