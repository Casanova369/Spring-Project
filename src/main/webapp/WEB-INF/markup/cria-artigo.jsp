...
<main>
    ...
    <form class="grid" action="/plataform/artigo/create" method="post">
        <label for="title"><b>Titulo do Artigo</b></label>
        <input type="text" placeholder="Digite um titulo" id="title" name="title" required>

        <label for="description">Texto do Artigo</label>

        <textarea id="description" name="description" rows="4" cols="50"></textarea>

        <button>Cria artigo</button>
    </form>
